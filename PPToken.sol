...
contract PPToken is BurnableToken{
    ...
    string public constant name = "PPToken";
...
contract WhitelistedCrowdsale is RefundableCrowdsale {

  mapping(address => bool) public whitelist;
  uint256 public whiteListCap;
  
  function WhitelistedCrowdsale(uint _whiteListCap) public{
      whiteListCap = _whiteListCap;
  }
  
  function setWhiteListCap(uint256 _cap) public onlyOwner{
      whiteListCap = _cap;
  }
   ...
   */
  function _preValidatePurchase(address _beneficiary, uint256 _weiAmount) internal {
        require(vault.depositOf(_beneficiary).add(_weiAmount) < whiteListCap || inWhiteList(_beneficiary));
        super._preValidatePurchase(_beneficiary, _weiAmount);
  }

}
contract StagebleCrowdsale is TimedCrowdsale{
    using SafeMath for uint256;
    ...
    function StagebleCrowdsale() public {
        ...
        stage[4]["bonus"] = 0;
        stage[4]["cap"] = token.totalSupply();
        stage[4]["tranmin"] = stage[1]["tranmin"];
        stage[4]["closeTime"] = closingTime;
...
contract PPTokenCrowdsale is  StagebleCrowdsale, CappedCrowdsale, WhitelistedCrowdsale, AllowanceCrowdsale{
    using SafeMath for uint256;
    ...
    */
    function PPTokenCrowdsale( PPToken _token) public
        ...
        WhitelistedCrowdsale(10 ether)// ~5000$
      {
        ...
        //the value needs to less or equal than a cap which is limit for accepted funds
        //require(_goal <= _cap);
        bountyWallet = 0xEA15Adb66DC92a4BbCcC8Bf32fd25E2e86a2A770;
        bountyPercent = 10;
        teamWallet = 0xEA15Adb66DC92a4BbCcC8Bf32fd25E2e86a2A770;
        teamPercent = 15;
        companyWallet = 0xEA15Adb66DC92a4BbCcC8Bf32fd25E2e86a2A770;
        companyPercent = 5;
        //PPToken(200, 1520899200 + (17 hours));//1520899200 - 2018-03-13 00: 00
      }
